module selftest_block(
    ...
    localparam MAX_CLK = 12'd4000;
    
    localparam IDLE = 3'd0;
    localparam USER_INPUT = 3'd1;
    localparam TEST_INIT = 3'd2;
    localparam GENERATING = 3'd3;
    localparam FUNC = 3'd4;
    localparam CRC = 3'd5;
            ...
            case(state)
                IDLE:
                    begin
                        ...
                        else if(test && clk_counter < MAX_CLK) begin
